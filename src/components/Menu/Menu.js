...
function Menu({ isMenuTransparent }) {
   const linkStyle = `py-3 mx-6 font-bold z-50 transition-colors duration-500 ${isMenuTransparent ? "text-white" : "black"}`;
   ...
   return (
      ...
      >
         <a className={linkStyle} href="/">
            {isMenuTransparent ? (
               <svg width="260" height="30" viewBox="0 0 369.5483870967742 60.15450534584235" className="looka-1j8o68f">
                  <defs id="SvgjsDefs1577"></defs>
                  <g
                     id="SvgjsG1578"
                     featurekey="PG4fjM-0"
                     transform="matrix(0.6986585491471426,0,0,0.6986585491471426,-6.637256216897855,-5.729000636040741)"
                     fill="#47abff"
                  >
                     <path
               ...
               <svg
                  width="260"
                  height="30"
                  viewBox="0 0 369.5483870967742 60.15450534584235"
