...
function Menu({ isMenuTransparent }) {
  ...
  return (
    ...
    >
      ...
      <a
        className="ms-32 me-6 py-3 px-6 h-12 font-bold text-white bg-indigo-500 rounded-md hover:bg-white hover:text-indigo-500 transition-colors duration-500"
        href="#"
      >
        获得支持
      </a>
