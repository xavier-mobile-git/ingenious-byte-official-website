...
function Menu({ isMenuTransparent }) {
  ...
  return (
    ...
    >
      ...
      <a
        className="ms-32 me-6 p-3 h-12 font-bold text-white bg-indigo-500 rounded-md hover:bg-indigo-400 transition-colors duration-500"
        href="#"
      >
        获得支持
      </a>
